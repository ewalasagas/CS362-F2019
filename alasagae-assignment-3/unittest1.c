...
//TEST 3: BARON FUNCTION EXECUTES?
        ...
        if(baron_ref(&G, 1, p) == 0) //put baron card in hand
        {
...
//TEST 5: BARON INCREASES NUM BUYS BY 1
        printf("---------------------------------------\n");
        printf("TEST 5: BARON INCREASES BUY ACTIONS BY +1\n");
        if(G.numBuys > 0 && G.numBuys < 3) 
        {
            printf("    PASS: Player buy actions increased by +1\n");
        }
        else
        {
            printf("    FAIL: Player buy actions remained at 1\n");
        }

//TEST 6: BARON CHOICE 1 -- GAIN +4 COINS 
        printf("---------------------------------------\n");
        printf("TEST 6: BARON CHOICE 1 -- GAIN +4 COINS\n");
        if((coinsB + 4) == coinsA) 
        {
            printf("    PASS: +4 coins added\n");
        }
        else
        {
            printf("    FAIL: +4 coins were not added\n");
        }
...
//TEST 7: BARON CHOICE 2 -- GAIN AN ESTATE
        ...
        {
            printf("    FALSE: Player does not gain an estate\n");
        }
