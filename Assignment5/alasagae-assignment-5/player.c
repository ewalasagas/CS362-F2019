/* 	
PURPOSE:
It has 2 main() functions. The main() function executes the dominion 
game and gives instructions players during the game.  The main2()
function is used to initialize a game.
*/
