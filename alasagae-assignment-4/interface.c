...
PURPOSE: 
It is the user interface file.  It defines several functions 
to print player, card, deck, action, and score in console. 
*/
...
int addCardToHand(int player, int card, struct gameState *game) {
    //NOTE: had to change "advernturer" to curse to add card to hand
    if(card >= curse && card < NUM_TOTAL_K_CARDS) {
